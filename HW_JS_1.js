...
console.log("item_2 =",item_2);//6) Вывести в консоль item_2.

let item_3 = item_1 + item_2;//7) Создать переменную “item_3”
...
console.log("summa item_3 i item_4 =",(item_3 + item_4));
//13)Вывести в консоль сложение item_3 и item_4.

console.log("umnogenie item_3*item_4",item_3*item_4);
//Вывести в консоль умножение item_3 и item_4.

let item_5 = item_3;//15. Создать переменную “item_5”
...
if(age_1 < age_2) {
  console.log("You don’t have access cause your age is" +" "+ age_1 + " "+ "It is less then");
}
...
const checkAge = function(age) {
     ...
     if (age < 18) {
      console.log("You don’t have access cause your age is" +" "+ age + " "+ "It is less than" + " " + "18")
...
else { console.log("Error, должен быть тип Number")

}
return(typeof(age))
}
console.log(checkAge2("angry racoon"));// проверка при значении переменной типа строка
...
const checkAge3 = function(age) {  
  age = Number(age);//может проскочить Nan,когда ввести буквы и цифры например,поэтому исключаем Nan с помощью if(!isNaN(age)

  if(!isNaN(age)){
  if (typeof(age) == 'number') 
  { 
  if (age < 18) {
    console.log("You don’t have access cause your age is" +" "+ age + " "+ "It is less than" + " " + age_2)
  } else if  (age >=18 && age < 60){
    console.log("Welcome !")
  }
    else if (age > 60) {
...
console.log(checkAge3("2rr"));
console.log(checkAge3(25));
console.log("---------------------4*----------------");

/*4**Преобразовать задание 3* таким образом, чтобы возраст вводится используя функцию prompt в
привязанной верстке
(prompt?
показывает сообщение и запрашивает ввод текста от пользователя. Возвращает напечатанный в поле ввода текст или null, если была нажата кнопка «Отмена» или Esc с клавиатуры.)*/
 ...
 let ageVyvod = prompt("Введите ваш возраст")
 checkAge3(ageVyvod)
